...
class m_alergia extends CI_Model {
    ...
    public function store($dados = null, $id = null) {
        ...
        if ($dados) {
            if ($id) {
                ...
                if ($this->db->update("Alergia", $dados)) {
                    return true;
                } else {
                    return false;
                }
            } else {
                if ($this->db->insert("Alergia", $dados)) {
                    return true;
                } else {
                    return false;
                }
    ...
    public function delete($id = null) {
        if ($id) {
            return $this->db->where('idDadoComplementar', $id)->delete('Alergia');
        }
    }
