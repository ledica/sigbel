...
class m_atendimento extends CI_Model {
     ...
     */
    public function get($id = null,$idCliente=null,$idConsulta=NULL) {
        if($idCliente){
        ...
        return $this->db->get('vConsultaAtendimento');
    }
    ...
    public function delete($id = null) {
        if ($id) {
            return $this->db->where('idAtendimento', $id)->delete('Atendimento');
        }
    }
