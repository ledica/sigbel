...
class m_cirurgia extends CI_Model {
    ...
    public function store($dados = null, $id = null) {
        ...
        if ($dados) {
            if ($id) {
                ...
                if ($this->db->update("Cirurgia", $dados)) {
                    return true;
                } else {
                    return false;
                }
            } else {
                if ($this->db->insert("Cirurgia", $dados)) {
                    return true;
                } else {
                    return false;
                }
    ...
    public function delete($id = null) {
        if ($id) {
            return $this->db->where('idDadoComplementar', $id)->delete('Cirurgia');
        }
    }
